...
// This function allows the user to exit the system and print a receipt
function exit() {
    content.innerHTML = '<form><h2>To Quit<br> click on "yes" and then the Exit button. To go back click on "NO" and the Enter button </h2> <input type="radio" id="answer1" name="answer" value="yes" /><p class=word1>YES</p> <input type="radio" class="input1" name="answer" value="no" /><p class=words><p class=word2>NO</p></form>';
